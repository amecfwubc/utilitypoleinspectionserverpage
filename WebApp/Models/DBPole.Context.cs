...
namespace WebApp.Models
{
    ...
    public partial class PoleInfoEntities : DbContext
    {
        public PoleInfoEntities()
            : base("name=PoleInfoEntities")
        {
        }
        ...
        public virtual DbSet<FileSavePath> FileSavePaths { get; set; }
